// To parse this data:
//
//   import { Convert, RespuestaGIFAPI } from "./file";
//
//   const respuestaGIFAPI = Convert.toRespuestaGIFAPI(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface RespuestaGIFAPI {
  data:       Gif[];
...
export class Convert {
  public static toRespuestaGIFAPI(json: string): RespuestaGIFAPI {
      return cast(JSON.parse(json), r("RespuestaGIFAPI"));
  }

  public static respuestaGIFAPIToJson(value: RespuestaGIFAPI): string {
      return JSON.stringify(uncast(value, r("RespuestaGIFAPI")), null, 2);
  }
}
